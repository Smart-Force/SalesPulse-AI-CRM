...
interface AddEditModuleModalProps {
  ...
  // Optionally pass a parentId when creating a submodule directly
...
const AddEditModuleModal: React.FC<AddEditModuleModalProps> = ({ onClose, onSave, moduleToEdit, allModules, parentId: initialParentId }) => {
    ...
    // Memoize the list of possible parents to prevent circular dependencies
    ...
    const handleSave = () => {
        ...
        onSave({ 
            ...
            isTemplate,
            availability,
            // Manage versioning and timestamps on save
            version: (moduleToEdit?.version || 0) + 1,
