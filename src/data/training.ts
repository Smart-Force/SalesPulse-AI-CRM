...
export const initialTrainingModules: TrainingModule[] = [
    // Top-level categories (modules without a parentId)
    {
        id: 'cat_sales_skills',
        title: 'Sales Skills',
    ...
    {
        id: 'mod5',
        title: 'Level 2 - Negotiation',
        parentId: 'mod2', // 2nd level nesting
        description: 'Advanced tactics for complex negotiations.',
        difficulty: 'Advanced',
        version: 1,
        lastUpdatedAt: new Date().toISOString(),
        resources: []
