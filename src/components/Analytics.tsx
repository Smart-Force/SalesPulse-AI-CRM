...
const funnelOrder: ProspectStatus[] = ['New', 'Contacted', 'Engaged', 'Meeting', 'Closed'];
const funnelColors = ['#4f46e5', '#6366f1', '#818cf8', '#a5b4fc', '#c7d2fe'];

export const Analytics: React.FC<AnalyticsProps> = ({ prospects, deals }) => {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <Card>
          <CardHeader>
            <CardTitle>Sales Performance (Mock Data)</CardTitle>
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <FunnelChart>
                        ...
                        <Funnel dataKey="value" data={funnelData} isAnimationActive>
                           <LabelList position="right" fill={document.documentElement.classList.contains('dark') ? '#e2e8f0' : '#1e293b'} stroke="none" dataKey="name" />
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card>
            <CardHeader>
                <CardTitle>Sales Leaderboard (Mock Data)</CardTitle>
          ...
          <Card>
            <CardHeader>
                <CardTitle>Deal Source Effectiveness (Mock Data)</CardTitle>
       ...
       <Card>
            <CardHeader>
                <CardTitle>Recent Deals (Mock Data)</CardTitle>
            </CardHeader>
